...
output_row = {
    "row": 3,
    "H": "https://example.com/related-article-1/",  # 貼るURL①
    "I": "内部リンクの重要性について",               # 貼る箇所見出し①
    "J": "https://example.com/related-article-2/",  # 貼るURL②
    "K": "SEOの基礎知識",                           # 貼る箇所見出し②
    "L": "",                                          # 貼るURL③（なければ空）
    "M": "",                                          # 貼る箇所見出し③（なければ空）
    "N": "done"                                       # 処理済みフラグ
...
## 出力形式（JSON）
{
  ...
  "recommended_heading": "リンクを貼るのに最適な候補記事内の見出しテキスト"
}
```
...
| ⑤ | クライアント | レビューOKの内容をWordPressに手動で内部リンクを設置する |

...
2. 起動後、以下を伝える：
   > 「内部リンクエージェントを起動しました。処理が完了したらSpreadsheetのH〜M列に候補が書き込まれます。PowerShellのターミナルで完了メッセージが出たら、ここに「完了しました」と送ってください。」
...
確認①②③が揃ったら、ローカルランナー経由でWP挿入ツールを起動する。

### パターン3：「内部リンクエージェントを実行して、そのままWP挿入もして」

1. 内部リンクエージェントを起動する
2. 起動後、以下を伝える：
   > 「内部リンクエージェントを起動しました。PowerShellのターミナルで完了メッセージが出たら、ここに「完了しました」と送ってください。」
